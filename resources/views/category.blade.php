...
<div class="flex justify-end mx-4 mt-4">
    <button id="target-addCategory" class="text-yellow-400 bg-black px-3 py-2 font-sans rounded-lg font-bold hover:bg-yellow-400 hover:text-white"><i class="fa-solid fa-plus mr-2  "></i>Add Category</button>
</div>
@if(session('message'))
...
{{-- add category --}}
<div id="add-category" data-modal-backdrop="static" tabindex="-1" aria-hidden="true" class="flex fixed hidden justify-center items-center top-0 left-0 right-0 z-50  w-full p-4 overflow-x-hidden overflow-y-auto bg-black bg-opacity-50 h-screen ">
        ...
        <div class="bg-white rounded-lg shadow dark:bg-gray-700 ">
            ...
            <form action="{{route('category.update')}}"   method="post" >
                ...
                <div class="mx-4 mt-6">
                    <div class="flex items-center justify-between">
                        <div class="w-full">
                            <input type="hidden" name="updateid_category" id="updateid_category">
                            <label for="name_dishes" class="font-serif block mb-2 text-sm font-medium text-gray-900 dark:text-white">name of category</label>
                ...
                <div class="flex items-center justify-end p-4 mt-4 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                    ...
                    <button id="declineUpdate-button" type="button" class="text-black font-sans bg-gray-100 hover:bg-gray-300  border-2 border-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Decline</button>
                </div>
            </form>
        </div>
    </div>
